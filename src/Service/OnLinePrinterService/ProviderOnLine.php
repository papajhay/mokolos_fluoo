...
//        $this->_curl->setUtf8Encode(true);
    ...
    private function _createUpdatOneOptionAndOptionsValue(string $sourceCode, Hosts $host, TProduct $product, int $keyOption)
    {
        ...
        $return['option'] = $this->toptionService->createIfNotExist($return['name'], Provider::class, $return['name'], $order, 0, TOption::TYPE_OPTION_SELECT, $specialOption);
        $this->tAProductOptionService->createIfNotExist(TProduct::class, $return['option'], $host);
