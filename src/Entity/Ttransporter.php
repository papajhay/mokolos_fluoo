...
class Ttransporter
{
     ...
     */
    const ID_TRANSPORTEUR_CHRONOPOST = 4;
...
//    }
     ...
     * @param string $traNom
     * @param string $traNomComplet nom complet tel que vu par le fournisseur
     * @param string $traTypeColis code du type de colis pour le mail de livraison
     * @param string $traSprite [=''] code pour le sprite si on en a un pour ce transporteur
