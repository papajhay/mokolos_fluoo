...
class TSupplierOrder
{
    ...
    #[ORM\Column]
    //statut de la commande chez le fournisseur
    private ?int $idSupplierOrderStatus = null;
    ...
    public function getIdSupplierOrderStatus(): ?int
    {
        return $this->idSupplierOrderStatus;
    }

    public function setIdSupplierOrderStatus(int $idSupplierOrderStatus): self
    {
        $this->idSupplierOrderStatus = $idSupplierOrderStatus;
