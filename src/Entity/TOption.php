...
//    }
     ...
     * @param string $nomOption libelle de l'option
     * @param int|NULL $ordre ordre de l'option
     * @param int $idProduit [optional=0] id du produit si applicable
     * @param int $typeOption [optional=TOption::TYPE_OPTION_SELECT] Type d'option (menu déroulant ou texte)
     * @param int $optSpecialOption [optional=TOption::SPECIAL_OPTION_STANDARD] indique si il s'agit d'une option spécial (quantité, délai, pays de livraison, ...). Voir constante de classe
     */
...
//    }
     ...
     * @param int $ordre l'ordre d'origine
...
//    }
     ...
     * @return boolean TRUE si c'est une option de délai et FALSE sinon
     */
...
//    }
     ...
     * @return boolean TRUE si c'est une option de quantité et FALSE sinon
     */
...
//    }
     ...
     * @param int $idProduit [=0] id du porduit ou 0 si non applicable
     * @return boolean
     */
