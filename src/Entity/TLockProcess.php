...
class TLockProcess
{
     ...
     * @param string $name nom du process
...
//    }
     ...
     * @param string $name nom du lockprocess
     * @return \TLockProcess
     */
...
//    }
     ...
     * @param int $locProTimestamp timestamp de l'execution du process
     * @param varchar(500) $locProStage Etape du process (facultatif)
     * @param int $locProStageTimestamp timestamp du lancement de l'étape
     * @param bigint $locProMemory [optional=0] mémoire utilisé en octet
