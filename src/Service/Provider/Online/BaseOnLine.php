...
namespace App\Service\Provider\Online;
...
//        }
     ...
     */
    private function initCurl($url, $param):void
    {
...
//        $this->_curl->setUtf8Encode(true);
     ...
     * @return string le masque
     */
    private function masqueOptionMenuDeroulant(): string
    {
     ...
     * @return string le masque
     */
    private function masqueOptionMenuDeroulantShort(): string
    {
     ...
     * @return string le masque
     */
    private function masqueOptionMenuDeroulantPrix(): string
    {
        $masque = '#&euro;\s*([\d,\.]+)[^\d,\.]#';
     ...
     * @return string
     */
    private function masqueSelected(): string
    {
        return '#checked#';
    }
     ...
     * @return string
     */
    private function masqueProduitIndisponible(): string
    {
     ...
     * @return string
     */
    private function masqueSupplementJourOuvre(): string
    {
...
//    }
     ...
     */
    public function extractPrix(TProduct $product, array $data, Hosts $host)
    {
        $this->_dataPost = $data;
     ...
     * @return type
     */
    public function extractDelaiOuPrix(TProduct $product, array $tabSelectionUtilisateur, Hosts $host)
    {
