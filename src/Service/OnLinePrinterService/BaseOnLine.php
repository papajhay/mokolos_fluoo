...
namespace App\Service\OnLinePrinterService;
...
use App\Service\Provider\OnLinePrinter\OrdersStatus;
use App\Service\Provider\OnLinePrinter\Prix;
use App\Service\Provider\OnLinePrinter\System;
use App\Service\Provider\OnLinePrinter\TLog;
use App\Service\Provider\OnLinePrinter\TOnlineProductRule;
use App\Service\Provider\OnLinePrinter\TTransporteur;

class BaseOnLine extends BaseProvider
{
    /**
...
//        $this->_curl->setUtf8Encode(true);
     ...
     * @return string
     */
    protected function _pcreSubProduct(): string
    {
     ...
     */
    protected function _masqueLigneTableau(): string
    {
        // initialisation du masque
        $masque	 = '#';
     ...
     * @return string le masque
     */
    protected function _masqueMultiTableau(): string
    {
        // initialisation du masque
        $masque	 = '#';
     ...
     * @return string le masque
     */
    protected function _pcreH1(): string
    {
        $masque	 = '#';
        $masque	 .= '<h1[^>]+>([^<]+)<';
        $masque	 .= '#';
     ...
     * @return string le masque
     */
    protected function _pcreOptionTitle(): string
    {
        $masque	 = '#^';
     ...
     * @return string le masque
     */
    protected function _pcreSelectOptionUnique(): string
    {
     ...
     * @return string le masque
     */
    protected function _pcreOptionTypeText(): string
    {
     ...
     * @return string
     */
    protected function _masqueFormProduct(): string
    {
     ...
     * @return string le masque
     */
    protected function _masqueInputHidden(): string
    {
     ...
     * @return string le masque
     */
    protected function masquePrix(): string
    {
        $masque	 = '#';
     ...
     * @return string
     */
    protected function _masqueDelaiHorsMenuDeroulant(): string
    {
        $masque	 = '#';
     ...
     * @return string
     */
    protected function _masqueDelaiMax(): string
    {
        return '#^(?:.*\D|)(\d+)\s*j#';
    }
     ...
     * @return string
     */
    protected function _pcreProdIndex(): string
    {
        $pcre	 = '#';
        $pcre	 .= '\n';
        $pcre	 .= 'prodIndex\s*:\s*\'([^\']+)\'';
     ...
     * @return string
     */
    protected function _pcreMailNewOrderSubject(): string
    {
     ...
     * @return string
     */
    protected function _pcreMailNewOrderBody(): string
    {
     ...
     * @return string
     */
    protected function _pcreMailProductionSubject(): string
    {
     ...
     * @return string
     */
    protected function _pcreMailOrderCanceledSubject(): string
    {
     ...
     * @return string
     */
    protected function _pcreMailResponseToARequestSubject(): string
    {
     ...
     * @return string
     */
    protected function _pcreMailNonCompliantStructuresSubject(): string
    {
     ...
     */
//    private function _createUpdateAllOptionAndOptionsValue(string $sourceCode, Hosts $host, TProduct $product)
//    {
//        $return		 = array();
//        $keyOption	 = 0;
...
//                $opionData = $this->_createUpdatOneOptionAndOptionsValue($itemConfig, $host, $product, $keyOption);
...
//        TAProductOption::createIfNotExist($product->getIdProduit(), $return['option'], $host);
...
//            TAProduitOption::createIfNotExist($product->getIdProduit(), $option['option'], $host, $option['value']);
...
//    }
     ...
     */
//    private function recuperationProduit(TProduct $product, int $idOptionValueOnline, Hosts $host, array &$tabDependance, array $tabSelectionUtilisateur)
//    {
//        $matchProdIndex		 = [];
//        $matchForm			 = [];
//        $matchInputHidden	 = [];
...
//    }
     ...
     */
//    private function traitementMenuDeroulant(array $dataOptionAndOptionValue, array $tabOptionValueUtilisateur)
//    {
